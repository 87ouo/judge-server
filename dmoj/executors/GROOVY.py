...
with open(
    os.path.join(os.path.dirname(__file__), 'groovy-security.policy')
) as policy_file:
...
'''
    ...
    def get_cmdline(self):
        ...
        res[-2:-1] = [
            '-Dsubmission.file=%s' % self._class_name
        ] + self.runtime_dict['groovy_args']
        return res
    ...
    def autoconfig(cls):
        ...
        result['groovy_vm'] = cls.unravel_java(
            cls.find_command_from_list([cmdline[1]])
        )
